        ...
        <div className="min-h-screen flex items-center px-2 ">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    className="bg-blue-700 hover:bg-blue-800 text-zinc-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
                        Register Your App
                    </button>
                </div>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
                    <div className="text-center">
                        ...
                        <h3 className="font-semibold text-zinc-100 mb-2">Smart Classification</h3>
                        <p className="text-zinc-400 text-sm">Automatically categorize errors by service, type, and severity</p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="font-semibold text-zinc-100 mb-2">Fast Processing</h3>
                        <p className="text-zinc-400 text-sm">Process large log files in seconds with intelligent filtering</p>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="font-semibold text-zinc-100 mb-2">Structured Output</h3>
                        <p className="text-zinc-400 text-sm">Get clean JSON summaries ready for analysis and visualization</p>
                    </div>
                </div>
            </div>
        </div>
